...
public class DefaultGamePlayerService implements GamePlayerService {
    ...
    public GamePlayer create(Game game, String playerName) {
        GamePlayer gamePlayer = GamePlayer.builder().playerName(playerName).game(game).playerCode(UUID.randomUUID())
                .build();
